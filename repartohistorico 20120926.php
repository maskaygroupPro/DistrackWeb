...
$tabla.="<tr><td colspan=13 align=center><font color=Navy><u><b>Ultimos 500 despachos históricos</b></u></font></td></tr>";
$tabla.="<tr>";
...
$query="select b.numpedido,b.idpedido,b.documento,left(b.cliente,40),b.volumen,b.distcliente,b.estado,b.fecentrega,concat(ventanaini,' - ',ventanafin),b.horentrega,b.localpedido,b.placa from ddaryza.pedidos b,gpslog.livedata l where b.fechaprog<curdate() and   b.placa=l.vehicleReg and b.placa in(select l.VehicleReg from gpslog.netusers n,gpslog.system_users s,gpslog.livedata l where l.VehicleID=n.UIN and n.NetUserUIN=s.ID and s.ID=".$_SESSION['ID'].") ".$and_saga.$and_ripley.$and_rizzoli.$and_varios." order by b.fechaprog desc limit 500";

$query = "select b.numpedido,b.idpedido,b.documento,left(b.cliente,40),b.volumen,b.distcliente,b.estado,b.fecentrega,b.horentrega,b.localpedido,b.placa,b.latitud,b.longitud,ventanaini,ventanafin,b.fechaprog from ddaryza.pedidos b                   where b.fechaprog<curdate() and b.placa in(select l.VehicleReg from gpslog.livedata l,gpslog.system_users s,gpslog.netusers n where l.VehicleID=n.UIN and n.NetUserUIN=s.ID and s.ID=".$sesion." ) ".$and_pedido.$and_guia.$and_placa.$and_fecha.$and_estado.$and_distrito.$and_sucursal." order by b.fechaprog desc limit 500;";
