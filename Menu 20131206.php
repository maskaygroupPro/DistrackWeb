...
if ($NO > 0){
	for ($i=1;$i<=$NO;$i++){
		if ($i == 1){
			...
			echo "<td nowrap class='RecSrcGridHeaderLLSort' align='center'>PlacaRef</td>";
		...
		echo "<td nowrap class='GridAttrField' align='left'>".$DRIVER[$i]."</td>";
		...
		echo "<td nowrap class='GridAttrField' align='right'>".$PESO[$i]."</td>";	
