                            ...
                            <table class="table table-striped table-hover js-exportable" id="example" cellspacing="0" width="100%">
                                    <thead style="background-color:#131212f7; color:white;">
                                        <tr>
                                            ...
                                            <th width="12%"><center>Distrito</center></th>
                                            <th width="8%"><center>Fecha</center></th>
                                            <th width="7%"><center>Llegada</center></th>
                                            <th width="7%"><center>Inicio</center></th>
                                            <th width="7%"><center>Final</center></th>
                                            <th width="10%"><center>Estado</center></th>
                                            <th width="7%"><center>Espera</center></th>
                                            <th width="7%"><center>Atencion</center></th>
                                    ...
                                    <tbody class="tabla-pedidos">
                                        ...
                                        <tr>
                                            ...
                                            <td class="right"><?=$value['fechaprog']?></td> 
