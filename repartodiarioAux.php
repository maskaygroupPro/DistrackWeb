...
$local = $_GET['local'];
$hastaAux = $_GET['hastaAux'];
$desdeAux = $_GET['desdeAux'];
...
$tabla.="</tr>";
	...
	echo "<script>console.log('Debug Objects: " . "HISTORICOOO" . "' );</script>";
	echo "<script>console.log('Debug Objects: " . $vfecha . "' );</script>";
	//$query = "select b.numpedido,b.idpedido,b.documento,left(b.cliente,40),b.volumen,b.distcliente,b.estado,b.fecentrega,b.horentrega,b.localpedido,b.placa,b.latitud,b.longitud,b.ventanaini,b.ventanafin,b.clasificacion,b.observacion,b.producto  from intralot.pedidos b where b.placa in(select l.VehicleReg from gpslog.livedata l,gpslog.system_users s,gpslog.netusers n where b.fechaprog=curdate() and l.VehicleID=n.UIN and n.NetUserUIN=s.ID and s.ID=".$sesion." ) ".$and_pedido.$and_guia.$and_placa.$and_fecha.$and_estado.$and_distrito.$and_sucursal." order by b.index1 desc limit 100 ";
	...
	where b.fechaprog>='". $desdeAux ."' and b.fechaprog<='". $hastaAux ."' order by b.placa,b.orden";
	$queryAux = "select (aux1)  from intralot.pedidos where aux1='1002010'";
	//SELECT (aux1) FROM `pedidos` WHERE aux1='1022230'
...
} else if ($local == 'historicoMateriales') {
	$tabla.="<tr>";
...
$tabla.="</tr>";
	...
	$query="call intralot.ObtenerReporteMateriales('". $desdeAux ."','". $hastaAux ."')";
	...
	$tabla.="<tr>";
	$tabla.="<td bgcolor=blue><b><font color=white>-</b></td>";//1
	$tabla.="<td bgcolor=blue><b><font color=white>Ord</b></td>";//1
	$tabla.="<td bgcolor=blue><b><font color=white>Terminal</b></td>";//4
	$tabla.="<td bgcolor=blue><b><font color=white>Nombre</b></td>";//6
	...
	$tabla.="</tr>";
		...
		$query="call intralot.ObtenerReportePedidos('". $desdeAux ."','". $hastaAux ."')";
