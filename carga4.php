...
<form action="" enctype="multipart/form-data" method="post" role="form">
    ...
    <button type="submit" class="btn btn-default" name="Import" value="Import">Cargar</button>
</form>
...
<form action="" enctype="multipart/form-data" method="post" role="form">
    ...
    <button type="submit" class="btn btn-default" name="Import2" value="Import2">Cargar</button>
</form>
...
if(isset($_POST["Import3"]))
{
    ...
    if($_FILES["file"]["size"] > 0)
    {
        ...
        while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
        {
            ...
            $codReparto_ = $terminal_.".".date("ymd", strtotime($fechaProg_));
...
<form action="" enctype="multipart/form-data" method="post" role="form">
    ...
    <button type="submit" class="btn btn-default" name="Import3" value="Import3">Cargar</button>
</form>
...
<form action="" enctype="multipart/form-data" method="post" role="form">
    ...
    <button type="submit" class="btn btn-default" name="Import4" value="Import4">CARGAR</button>
</form>
