...
function show_calendar2(str_target, str_datetime) {
	...
	var vWinCal = window.open("", "Calendar", 
		"width=200,height=210,status=no,resizable=no,top=200,left=450,toolbars=no,location=no,titlebar=no,status=no");
	vWinCal.opener = self;
	vWinCal.focus();
...
if (dt_datetime.getMonth()+1 < 10)
	{return (new String (dt_datetime.getDate()+"-0"+(dt_datetime.getMonth()+1)+"-"+dt_datetime.getFullYear()));
	}
else
